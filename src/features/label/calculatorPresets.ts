...
export const COMPOUND_AMOUNT_PRESETS_MG = ['5', '10', '15', '20', '30', '50', '100'] as const
export const COMPOUND_AMOUNT_PRESETS_IU = ['1000', '2000', '5000', '10000'] as const
...
export function compoundAmountPresets(vialUnit: 'mg' | 'IU' | undefined): readonly string[] {
    return vialUnit === 'IU' ? COMPOUND_AMOUNT_PRESETS_IU : COMPOUND_AMOUNT_PRESETS_MG
}
...
export function drawUnitsPresets(syringeCapacityMl: SyringeCapacityMl): string[] {
    const max = syringeMaxUnits(syringeCapacityMl)
