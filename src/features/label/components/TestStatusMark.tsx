...
export function TestStatusMark({ status, sizePx, baseWidthPx }: TestStatusMarkProps) {
  ...
  return (
    ...
    >
      <rect x="1" y="1" width="22" height="22" fill="#ffffff" stroke="#000000" strokeWidth="2.5" />
      {status === 'pass' && (
        <polyline
      ...
      {status === 'fail' && (
        <>
          <line x1="7" y1="7" x2="17" y2="17" stroke="#000000" strokeWidth="2.5" strokeLinecap="square" />
          <line x1="17" y1="7" x2="7" y2="17" stroke="#000000" strokeWidth="2.5" strokeLinecap="square" />
        </>
      )}
    </svg>
  )
